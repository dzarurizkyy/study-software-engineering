...
│                   COMMUNITY FLYWHEEL                    │
│                                                         │
│   You Join          You Contribute       You Get Seen   │
│  Community    ──►   Help Others   ──►   by Seniors      │
│                     Share Work                          │
│       ▲                                      │          │
│       │                                      ▼          │
│   Skills Grow   ◄──  You Get         Opportunities      │
│   Naturally          Referred         Find YOU          │
└─────────────────────────────────────────────────────────┘
```
...
- Don't wait until you're "senior" — start now as a student
- Both online communities and offline meetups count
...
└──────────────────────────┬───────────────────┘
        ...
        Approved       Rejected       Partial
             │             │              │
      Use Y freely   Follow rules   Pass with X,
      for the task   to pass exam   deep-dive Y
                                    outside class
```
...
| Looks impressive on paper | Actually impressive in practice |
...
❌ Vague Instruction (Intuition-based)
   "Fry until hot"
   "Add salt to taste"
   └─► Every cook produces different results

✅ Precise Instruction (Computational thinking)
   "Heat oil to 170°C for exactly 3 minutes"
   "Add exactly 5 grams of salt"
   └─► Consistent, replicable, scalable results
```
...
│                                                         │
│  Decomposition   Abstraction   Pattern       Algorithm  │
│  ─────────────   ───────────   Recognition   ─────────  │
│  Break big       Focus on      Find repeated  Define    │
│  problems into   what matters, similarities  clear,    │
│  small steps     ignore noise  in problems   step-by-  │
│                                              step rules │
└─────────────────────────────────────────────────────────┘
```
...
Step 2: Train computational thinking on code.org
        │
Step 3: Resume coding with a stronger mental model
        │
Step 4: You'll progress significantly faster
```

> The "ghost bug" — code works on your laptop but breaks on others — is almost always caused by unstructured, intuition-based coding.

---

## 💼 How to Land a Job (SoftSkill 1)
...
│                      │         │                      │
│  "I can't find a     │         │  "We can't find      │
│   good job!"         │         │   good talent!"      │
└──────────────────────┘         └──────────────────────┘
           │                                │
           └────────────┬───────────────────┘
                        ▼
...
Wasted time          vs.    Focused skill building
No feedback          vs.    Regular course correction
Confused direction   vs.    Industry-aligned path
```
...
│                                                         │
│   Learn Something  ──►  Write/Share It  ──►  Publish   │
│         ▲                                        │      │
│         │                                        ▼      │
│   Keep Learning    ◄──  Build Reputation  ◄── You're   │
│                         as Expert              Found    │
└─────────────────────────────────────────────────────────┘
```

- Write blog posts about what you just learned
...
- Help others with coding questions — this demonstrates competence publicly
...
Student / Entry Level
       ...
       │
       ├─► Find a Mentor (ask for roadmap, not tutoring)
       │
       ├─► Build in Public (blog, videos, forums)
       │
       ├─► Join Communities (contribute, help others)
       │
       └─► Optional: Scholarship / Hackathon
                 │
                 ▼
       Already Visible to Industry
       Before You Even Graduate
```

---

## 💰 How to Get a Raise (SoftSkill 2)
...
│  10 targets assigned               │
│                                    │
│  ❌ Hit exactly 10  →  No raise   │
│  ✅ Hit 11–12      →  You stand   │
│                       out          │
└────────────────────────────────────┘

OR: Deliver the same tasks faster & at higher quality
...
- Example: Senior Engineer → ask to lead a small project or coordinate a team
...
Many employees feel salary talk is taboo
 ...
 Steps:
 1. Request a 1-on-1 with your manager
 2. Present your contributions and achievements
 3. Ask clearly for a salary adjustment
 4. If denied → get feedback on what to improve next
```
...
- Switching is one of the fastest ways to get a significant compensation jump
- New companies pay market rate for experienced talent
...
3. Bring it to your current employer
4. Negotiate a counter-offer
5. Decide: stay (with raise) or leave (still a win)
...
Have you asked for more responsibility?
       │
  Yes  │  No ──────► Request a bigger scope from manager
       │
       ▼
Have you asked directly?
       │
  Yes  │  No ──────► Schedule a 1-on-1 today
       │
       ▼
Is the company still not responding?
       │
  Yes  │  No ──────► Give it a defined deadline
       │
       ▼
...
| Switch Jobs | If underpaid | Medium | ⭐⭐⭐⭐ |
| Fake-Out | Last resort | High | ⭐⭐ |
